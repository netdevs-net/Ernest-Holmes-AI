...
<div class="about-page">
  ...
  <section class="hero" role="banner">
    ...
    <div class="hero-content">
      ...
      <p class="hero-subtitle">
        ...
        <span class="subtitle-highlight">for the Digital Age</span>
      </p>
      <div class="hero-stats">
        <div class="stat-item">
          <div class="stat-number">1887</div>
          <div class="stat-label">Ernest Holmes Born</div>
        </div>
        <div class="stat-divider"></div>
        <div class="stat-item">
          <div class="stat-number">∞</div>
          <div class="stat-label">Timeless Wisdom</div>
        </div>
        <div class="stat-divider"></div>
        <div class="stat-item">
          <div class="stat-number">AI</div>
          <div class="stat-label">Modern Technology</div>
        </div>
      </div>
  ...
  <div class="container">
      ...
      <div class="mission-content">
        <div class="mission-text">
          ...
          <div class="text-block">
            <p>
              Ernest Holmes (1887-1960) was a spiritual teacher, writer, and the founder of Religious Science, 
              now known as Centers for Spiritual Living. His teachings have touched millions of lives, offering 
              practical spiritual wisdom that transcends time and culture.
            </p>
          </div>
          <div class="text-block">
            <p>
              Our mission is to preserve and perpetuate Holmes' authentic voice and teachings through cutting-edge 
              AI technology, ensuring that future generations can access his wisdom in a way that feels personal, 
    ...
    <section class="section sponsorship-section" aria-labelledby="sponsorship-heading">
      <div class="section-header">
        <div class="section-badge">Gratitude</div>
...
<style>
  ...
  .avatar-ring {
    ...
    border-radius: 50%;
    background: linear-gradient(45deg, var(--text-accent), var(--text-accent-hover));
    z-index: -1;
  }
  ...
  .avatar-glow {
    ...
    border-radius: 50%;
    background: linear-gradient(45deg, var(--text-accent), var(--text-accent-hover), #10b981);
    z-index: -1;
  }
