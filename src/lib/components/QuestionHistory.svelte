<script lang="ts">
  import { QuestionStorage, type QuestionHistory } from '$lib/utils/questionStorage';
  ...
  function deleteQuestion(questionId: string) {
    if (confirm('Are you sure you want to delete this question?')) {
      QuestionStorage.deleteQuestion(questionId);
      loadQuestions();
    }
  }
...
{#if isVisible}
  <div class="question-history-panel">
    ...
    <div class="history-header">
      <h3>Your Spiritual Questions ({QuestionStorage.getQuestionCount()})</h3>
      <div class="header-actions">
        <button class="export-btn" on:click={exportQuestions}>
          Export
        </button>
    ...
    <div class="filters">
      ...
      <div class="filter-actions">
        <label class="bookmark-filter">
          ...
          Bookmarked only ({QuestionStorage.getBookmarkedCount()})
        </label>
